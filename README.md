...
<header class="Header  f5" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scoped-search-url="/Canvas-Project/homeroom/search" data-unscoped-search-url="/search" action="/Canvas-Project/homeroom/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <span class="author" itemprop="author"><a class="url fn" rel="author" href="/Canvas-Project">Canvas-Project</a></span><!--
--><span class="path-divider">/</span><!--
--><strong itemprop="name"><a data-pjax="#js-repo-pjax-container" href="/Canvas-Project/homeroom">homeroom</a></strong>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    ...
    <a data-hotkey="g b" class="js-selected-navigation-item reponav-item" data-selected-links="repo_projects new_repo_project repo_project /Canvas-Project/homeroom/projects" href="/Canvas-Project/homeroom/projects">
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <!-- blob contrib key: blob_contributors:v21:28ff51ef31219f6f267662d3c2110573 -->
...
<span class="pl-k">class</span> <span class="pl-en">App</span> <span class="pl-k">extends</span> <span class="pl-e">Component</span> {
  <span class="pl-en">handleClick</span> <span class="pl-k">=</span> () <span class="pl-k">=&gt;</span> {
    <span class="pl-k">import</span>(<span class="pl-s"><span class="pl-pds">'</span>./moduleA<span class="pl-pds">'</span></span>)
      .<span class="pl-en">then</span>(({ moduleA }) <span class="pl-k">=&gt;</span> {
...
<div class="highlight highlight-source-batchfile"><pre><span class="pl-k">set</span> <span class="pl-pds">"</span><span class="pl-smi">REACT_APP_SECRET_CODE</span><span class="pl-k">=</span>abcdef<span class="pl-s">"</span> <span class="pl-k">&amp;&amp;</span> npm <span class="pl-k">start</span></pre></div>
...
from <a href="/Canvas-Project/homeroom/blob/master/src/index.js"><code>src/index.js</code></a>.</p>
...
<a href="/Canvas-Project/homeroom/blob/master/src/index.js"><code>src/index.js</code></a> first by modifying the service worker import:</p>
...
in all web browsers. Service worker registration <a href="/Canvas-Project/homeroom/blob/master/src/registerServiceWorker.js">won't be attempted</a>
...
starting point, you can make use of the logic included in <a href="/Canvas-Project/homeroom/blob/master/src/registerServiceWorker.js"><code>src/registerServiceWorker.js</code></a>, which
...
<a href="/Canvas-Project/homeroom/blob/config/webpack.config.prod.js"><code>webpack.config.prod.js</code></a>.</p>
</li>
</ol>
...
<a href="/Canvas-Project/homeroom/blob/master/public/manifest.json"><code>public/manifest.json</code></a>, that you can customize with
details specific to your web application.</p>
<p>When a user adds a web app to their homescreen using Chrome or Firefox on
Android, the metadata in <a href="/Canvas-Project/homeroom/blob/master/public/manifest.json"><code>manifest.json</code></a> determines what
...
options of the <code>SWPreachePlugin</code> <a href="/Canvas-Project/homeroom/blob/config/webpack.config.prod.js">configuration</a>.</p>
<p>When users install your app to the homescreen of their device the default configuration will make a shortcut to <code>/index.html</code>. This may not work for client-side routers which expect the app to be served from <code>/</code>. Edit the web app manifest at <a href="/Canvas-Project/homeroom/blob/master/public/manifest.json"><code>public/manifest.json</code></a> and change <code>start_url</code> to match the required URL scheme, for example:</p>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.42633s from unicorn-1231706736-d1xsd">GitHub</span>, Inc.</li>
